-- Identidade da unidade na agenda: quem atende mais de um estabelecimento precisa
-- saber, olhando o card, em qual casa é o evento. Vai POR EVENTO (e não só no topo)
-- para continuar correto no dia em que uma agenda reunir casas diferentes.
