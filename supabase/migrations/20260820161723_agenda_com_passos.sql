-- Cascata dos passos também no app logado
CREATE OR REPLACE FUNCTION public.my_task_toggle(p_task_id uuid, p_done boolean)
...
-- A agenda passa a levar os passos junto de cada tarefa (eventos e avulsas)
